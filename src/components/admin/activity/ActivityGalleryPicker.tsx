...
interface ActivityGalleryPickerProps {
  value: string[];
  onChange: (urls: string[]) => void;
}

const ActivityGalleryPicker = ({
  value,
  onChange,
}: ActivityGalleryPickerProps) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-sm text-slate-500">
        ...
        "Activity Gallery" section on the public activity page.
      </p>
...
export default ActivityGalleryPicker;
